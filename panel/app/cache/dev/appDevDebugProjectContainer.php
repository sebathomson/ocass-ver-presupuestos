...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'monitor.conexion_webservice' => 'getMonitor_ConexionWebserviceService',
            'monitor.utils' => 'getMonitor_UtilsService',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8810e31102d944aaa65c1132c72b3105b21fd7c1436068183f5b58210f3c99e3');
    ...
    /**
     * Gets the 'monitor.conexion_webservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\ConexionWebService A AppBundle\Services\ConexionWebService instance.
     */
    protected function getMonitor_ConexionWebserviceService()
    {
        return $this->services['monitor.conexion_webservice'] = new \AppBundle\Services\ConexionWebService($this->get('logger'), 'http://201.236.20.29/WS_validar_seguridad_usuario/WebService.asmx?wsdl', 'FF0000');
    }

    /**
     * Gets the 'monitor.utils' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\UtilsService A AppBundle\Services\UtilsService instance.
     */
    protected function getMonitor_UtilsService()
    {
        return $this->services['monitor.utils'] = new \AppBundle\Services\UtilsService($this);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5afaaafdedd1374d18be644bc5b717332b884b6a');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57587eb68d8707.63949090')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '5afaaafdedd1374d18be644bc5b717332b884b6a',
            'urlwebservice' => 'http://201.236.20.29/WS_validar_seguridad_usuario/WebService.asmx?wsdl',
            'colordefault' => 'FF0000',
            'locale' => 'en',
            ...
            'kernel.secret' => '5afaaafdedd1374d18be644bc5b717332b884b6a',
