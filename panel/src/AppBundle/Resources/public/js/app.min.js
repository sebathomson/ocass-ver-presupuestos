...
$(document).on('ready', function() {
    ...
    setTimeout(function () {
        ...
        margin = margin + (ancho_equivalente_dia * diaactual) + 16 + 12;

        $('#img-flecha-dia-actual').css('margin-left', margin);
        $('#div-linea-dia-actual').css('margin-left', margin + 15);
        $('#div-linea-dia-actual').css('height', $('.table-responsive').height());
        $('#span-dia-actual').css('margin-left', (ancho_equivalente_dia * diaactual));

        $('#th-costado-izquierdo').width( $('.td-logo').width() );
        $('#th-cursos-no-terminados').width( $('.td-nombre-empresa').width() );

        $.each(mesanios, function(index, val) {
            $('#mes-'+index).width( $('#mes-'+index+'-base').width() );
            console.log( index );
        });
    ...
    $('#img-logo').on('click', function() {
        ...
        $.post(url_obtenerSelectSucursales, null, function(data) {
    ...
    $('#img-flecha-dia-actual').on('click', function() {
        ...
        $.post(url_obtenerVistaReporte, null, function(data) {
